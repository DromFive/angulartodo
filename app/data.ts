...
export const TODO: TodoItem[] = [
    ...
    new TodoItem({id: 4, title: '#US4', details: 'En tant qu’utilisateur je visualise le menu de navigation sur toutes les pages.',  done: true}),
    new TodoItem({id: 5, title: '#US5', details: 'En tant qu’utilisateur je peux accéder aux pages « Tâche à faire » et « Archives » depuis la navigation.', done: true}),
    new TodoItem({id: 6, title: '#US6', details: 'En tant qu’utilisateur je peux voir la liste des tâches réalisées sur la page « Archives ».', done: true}),
    new TodoItem({id: 7, title: '#US7', details: 'En tant qu’utilisateur je peux supprimer définitivement une tâche de la liste de la page «  Archives », ce qui supprime la tâche de la liste des tâches effectuées.', done: true}),
