...
export const TODO: TodoItem[] = [
    ...
    new TodoItem({id: 2, title: '#US2', details: 'En tant qu’utilisateur je peux valider une tâche en cliquant sur le bouton « Effectuée » sur chaque tâche de la liste des tâches à réaliser, ce qui supprime la tâche de la liste des tâches à réaliser.', done: false}),
